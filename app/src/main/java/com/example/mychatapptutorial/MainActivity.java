    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msendotp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mgetphonenumber.getText().toString().isEmpty())
                {
                    mgetphonenumber.setError("Please Enter Your number");
                    return;
                }
                else if(mgetphonenumber.getText().toString().length()<11)
                {
                ...
                else
                {
                    ...
                    phonenumber=countrycode+mgetphonenumber.getText().toString();
